    ...
    <div className='py-[10px]'>
      <Container>
        <div className='w-full bg-[#F4F6FC] py-5'>
          ...
          <h1 className='lg:text-[48px] text-[24px] font-bold text-[#282938] lg:w-[600px] mx-auto text-center'>
            Design that solves problems, one product at a time
          </h1>
        </div>

        <div className='w-full lg:flex text-center lg:text-left lg:py-10 justify-between flex-wrap gap-y-5'>
          <div>
        ...
        <div className='w-full lg:flex text-center lg:text-left justify-between flex-wrap gap-y-5 mt-5'>
          <div>
