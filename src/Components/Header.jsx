...
`}>
            <li className='lg:text-[16px] text-[14px]'>
              <Link to="/" className='flex gap-1 pl-4 items-center'>
                <CiHome className='lg:hidden text-right' /> Home
              </Link>
            </li>
            <li className='lg:text-[16px] text-[14px]'>
              <Link to="/about" className='flex gap-1 pl-4 items-center'>
                <FcAbout className='lg:hidden' /> About us
              </Link>
            </li>
            ...
            <li className='lg:text-[16px] text-[14px] lg:px-6 lg:border-1 lg:border-white lg:text-white text-black lg:py-2 rounded-[16px]'>
              <a className='flex gap-1 pl-4 items-center' href="#"><IoIosContact className='lg:hidden' /> Contact</a>
            </li>
          </ul>
        </div>
