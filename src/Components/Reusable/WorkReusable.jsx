...
const WorkReusable = ({image, title}) => {
  return (
    <>
                ...
                <p className='lg:text-[16px] text-[10px] text-black lg:w-[300px] w-full lg:text-left tex-center  pl-2 lg:pl-0'>Euismod faucibus turpis eu gravida mi. Pellentesque et velit aliquam .</p>
